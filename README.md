...
- [Theoretical and Mechanical Analysis](#theoretical-and-mechanical-analysis) (20)
- [Architecture and Algorithm Designs](#architecture-and-algorithm-designs) (53)
...
<!-- AUTO-GENERATED by scripts/build.py on 2026-05-22 00:16 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
...
- <details>
  ...
  <div><strong>Loop Mechanism:</strong> implicit-layer</div>
  <div><strong>Focus:</strong> architecture · inference-algorithm</div>
  <div><strong>Domains:</strong> neuroscience · sequence-modeling</div>
